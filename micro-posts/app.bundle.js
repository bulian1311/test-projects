      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return http.get('posts?key=bulian1311');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 2;
            _context2.next = 5;
            return http.post('posts?key=bulian1311', { title: title, content: content });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 2;
            _context3.next = 5;
            return http.delete('posts/' + id + '?key=bulian1311');
...
var http = new _http2.default('https://reduxblog.herokuapp.com/api/');
  ...
  _createClass(UI, [{
    ...
    value: function showPosts(posts) {
      ...
      posts.forEach(function (post) {
        output += '\n        <div class="card mt-3">\n          <div class="card-body">\n            <h4 class="card-title">' + post.title + '</h4>\n            <p class="card-text">' + post.content + '</p>\n            <a id="delete" class="delete card-link" href="#" data-id="' + post.id + '">\n              <i class="fas fa-times fa-lg float-right"></i>\n            </a>\n          </div>\n        </div>\n      ';
      });
      this.posts.innerHTML = output;
    }
  }, {
    key: 'showAllert',
    value: function showAllert(message, className) {
